...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern char ESP8266_rx_buffer[];		//缓冲区大小1024
extern uint16_t ESP8266_rx_len;				//缓冲区已使用字节
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    ...
    {
        // 存入大数组
        if(ESP8266_rx_len < (RX_BUF_MAX_LEN - 1))
        {
            ESP8266_rx_buffer[ESP8266_rx_len++] = aRxBuffer;
